        ...
        .then(() => {
          ...
          SQLite.openDatabase(
            ...
            .then(DB => {
              ...
              db.executeSql('SELECT 1 FROM Transactiondet LIMIT 1').then(() => {
                ...
                db.transaction((tx) => {
                  ...
                  tx.executeSql('CREATE TABLE IF NOT EXISTS Orders ( orderId INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, status TEXT NOT NULL,unitsOrdered INTEGER NOT NULL,  totalPrice INTEGER NOT NULL, orderCreatedOn TEXT NOT NULL, customerId INTEGER, itemId TEXT , FOREIGN KEY (customerId) REFERENCES Customer(customerId)  ON UPDATE CASCADE ON DELETE CASCADE, FOREIGN KEY (itemId) REFERENCES Inventory(itemId) ON DELETE CASCADE  )');
